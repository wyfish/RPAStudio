...
namespace RPA.OpenCV.Activities.Mouse
{
    ...
    public sealed class ImageWaitActivity : CodeActivity
    {
        ...
        public string icoPath {
            get {
                return @"pack://application:,,,/RPA.OpenCV.Activities;Component/Resources/Mouse/WaitAttr.png";
            }
        }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            try
            {
                ...
                var ret = Common.CVMouseAction(SourceImgPath, FlaxCV.CvActionType.DoNothing, title, matchingThreshold, matchingInterval, retry);
