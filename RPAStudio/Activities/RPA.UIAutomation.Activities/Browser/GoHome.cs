...
namespace RPA.UIAutomation.Activities.Browser
{
    ...
    public sealed class GoHome : AsyncCodeActivity
    {
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/RPA.UIAutomation.Activities;Component/Resources/Browser/GoHome.png";
            }
        }
        ...
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
        {
            ...
            if (thisBrowser == null)
            {
                ...
                {
                    getBrowser.getIEBrowser().GoHome();
                }
                //确保页面是否已加载完成
            ...
            else
            {
                ...
                {
                    thisBrowser.getIEBrowser().GoHome();
                }
                //确保页面是否已加载完成
