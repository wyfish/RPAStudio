...
namespace RPA.UIAutomation.Activities.Image
{
    ...
    public sealed class ImageHoverActivity : CodeActivity
    {
        ...
        public string icoPath {
            get {
                return @"pack://application:,,,/RPA.UIAutomation.Activities;Component/Resources/Mouse/hover.png";
            }
        }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            try
            {
                ...
                var ret = ImageActionCommon.CVMouseAction(SourceImgPath, FlaxCV.CvActionType.Move, title, matchingThreshold, matchingInterval, retry);
