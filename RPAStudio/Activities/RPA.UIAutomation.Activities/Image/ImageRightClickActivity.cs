...
namespace RPA.UIAutomation.Activities.Image
{
    ...
    public sealed class ImageRightClickActivity : CodeActivity
    {
        public new string DisplayName;
        [Browsable(false)]
        public string _DisplayName { get { return "Image RightClick"; } }
        ...
        public string icoPath {
            get {
                return @"pack://application:,,,/RPA.OpenCV.Activities;Component/Resources/Mouse/mouseclick.png";
            }
        }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            try
            {
                ...
                var ret = ImageActionCommon.CVMouseAction(SourceImgPath, FlaxCV.CvActionType.RightClick, title, matchingThreshold, matchingInterval, retry);
                Result.Set(context, ret.IsMatched);
            }
            catch (Exception e)
            {
                SharedObject.Instance.Output(SharedObject.enOutputType.Error, "Error on Executing ImageRightClickActivity()", e.Message);
