...
namespace RPA.UIAutomation.Activities.OCR
{
    ...
    public sealed class BaiDuOCRLocationActivity : CodeActivity
    {
        ...
        [Localize.LocalizedDisplayName("DisplayName76")]//语言类型 //Language type //言語の種類
        [Localize.LocalizedDescription("Description124")]//识别语言类型，默认为CHN_ENG。//Identify the language type, the default is CHN_ENG.//言語の種類を識別します。デフォルトはCHNuENGです。
        [Browsable(true)]
