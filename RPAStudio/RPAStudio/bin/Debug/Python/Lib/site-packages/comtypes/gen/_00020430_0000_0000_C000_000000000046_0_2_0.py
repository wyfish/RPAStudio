...
IFontDisp = Font
__all__ = [ 'StdFont', 'Checked', 'OLE_XPOS_PIXELS',
           'OLE_YSIZE_PIXELS', 'OLE_ENABLEDEFAULTBOOL',
           'FONTSTRIKETHROUGH', 'OLE_YSIZE_CONTAINER', 'FONTSIZE',
           'OLE_YPOS_PIXELS', 'LoadPictureConstants',
           'OLE_XSIZE_HIMETRIC', 'OLE_YPOS_CONTAINER', 'OLE_HANDLE',
           'FONTBOLD', 'OLE_XSIZE_PIXELS', 'VgaColor', 'IFontDisp',
           'Unchecked', 'Picture', 'Monochrome', 'IPictureDisp',
           'OLE_TRISTATE', 'FONTITALIC', 'OLE_COLOR',
           'OLE_OPTEXCLUSIVE', 'FONTNAME', 'Default',
           'OLE_CANCELBOOL', 'OLE_XPOS_CONTAINER', 'IFontEventsDisp',
           'Font', 'StdPicture', 'OLE_XSIZE_CONTAINER',
           'OLE_YSIZE_HIMETRIC', 'FONTUNDERSCORE', 'Color',
           'IPicture', 'FontEvents', 'IFont', 'OLE_YPOS_HIMETRIC',
           'Gray', 'OLE_XPOS_HIMETRIC']
